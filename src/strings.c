...
const u8 gText_PokeBalls2[] = _("MONSTER BALLS");
...
const u8 gText_PokeBalls[] = _("MONSTER BALLS");
...
const u8 gText_RareCandy_4000Coins[] = _("RARE CANDY{CLEAR_TO 0x50}{FONT_SMALL}4,000 COINS");
