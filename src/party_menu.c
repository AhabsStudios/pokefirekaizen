...
static u8 CanMonLearnTMTutor(struct Pokemon *mon, u16 item, u8 tutor)
{
    ...
    if (item >= ITEM_TM01_MEGA_PUNCH)
    {
        if (!CanMonLearnTMHM(mon, item - ITEM_TM01_MEGA_PUNCH))
...
{
    u16 tmNumber = item - ITEM_TM01_MEGA_PUNCH;
...
static void DisplayLevelUpStatsPg1(u8 taskId)
{
    ...
    DrawLevelUpWindowPg1(arrayPtr[12], arrayPtr, &arrayPtr[5], TEXT_COLOR_WHITE, TEXT_COLOR_DARK_GRAY, TEXT_COLOR_LIGHT_GRAY);
