...
static const struct MenuAction sMultichoiceList_GameCornerBattleItemPrizes[] = {
    { gText_RareCandy_4000Coins },
    { gText_PPUp_3000Coins },
    { gText_MoonStone_2000Coins },
    { gText_Elixir_1000Coins },
    { gText_Ether_500Coins },
    { gText_NoThanks_2 }
};
...
static const struct MultichoiceListStruct sMultichoiceLists[] = {
    ...
    [MULTICHOICE_THIRSTY_GIRL_MIX_AU_LAIT]                      = MULTICHOICE(sMultichoiceList_ThirstyGirlLemonade),
    [MULTICHOICE_THIRSTY_GIRL_FRESH_WATER_MIX_AU_LAIT]          = MULTICHOICE(sMultichoiceList_ThirstyGirlFreshWaterLemonade),
    [MULTICHOICE_THIRSTY_GIRL_SODA_POP_MIX_AU_LAIT]             = MULTICHOICE(sMultichoiceList_ThirstyGirlSodaPopLemonade),
    [MULTICHOICE_THIRSTY_GIRL_FRESH_WATER_SODA_POP_MIX_AU_LAIT] = MULTICHOICE(sMultichoiceList_ThirstyGirlFreshWaterSodaPopLemonade),
