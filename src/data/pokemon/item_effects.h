...
const u8 *const gItemEffectTable[] =
{
    ...
    [ITEM_MIX_AU_LAIT - ITEM_POTION]      = sItemEffect_Lemonade,
    ...
    [ITEM_TAURINE - ITEM_POTION]       = sItemEffect_Protein,
    [ITEM_BROMHEXINE - ITEM_POTION]          = sItemEffect_Iron,
    [ITEM_INDOMETACIN - ITEM_POTION]        = sItemEffect_Carbos,
    [ITEM_LYSOZYME - ITEM_POTION]       = sItemEffect_Calcium,
