const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_GOLBAT]     = {{EVO_ITEM, ITEM_SUN_STONE, SPECIES_CROBAT}},
    ...
    [SPECIES_KADABRA]    = {{EVO_LEVEL, 48, SPECIES_ALAKAZAM}},
    ...
    [SPECIES_GRAVELER]   = {{EVO_LEVEL, 45, SPECIES_GOLEM}},
    ...
    [SPECIES_HAUNTER]    = {{EVO_LEVEL, 45, SPECIES_GENGAR}},
