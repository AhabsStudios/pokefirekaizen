const u8 gMoveNames[MOVES_COUNT][MOVE_NAME_LENGTH + 1] = {
    ...
    [MOVE_MEGA_PUNCH]    = _("MEGATONPUNCH"),
    ...
    [MOVE_DIG]           = _("DIG"),
    [MOVE_TOXIC]         = _("TOXIC"),
    [MOVE_CONFUSION]     = _("WILLPOWER"),
    [MOVE_PSYCHIC]       = _("PSYCOKINESIS"),
    ...
    [MOVE_LEECH_LIFE]    = _("SUCK BLOOD"),
    [MOVE_LOVELY_KISS]   = _("LOVELY KISS"),
    [MOVE_SKY_ATTACK]    = _("GOD BIRD"),
