const u8 gTrainerClassNames[][13] = {
    ...
    [TRAINER_CLASS_RS_ELITE_FOUR]       = _("SHITENNO"),
    ...
    [TRAINER_CLASS_LASS]                = _("MINISKIRT"),
    ...
    [TRAINER_CLASS_SUPER_NERD]          = _("SCIENCE NERD"),
    [TRAINER_CLASS_HIKER]               = _("MOUNTAINEER"),
    [TRAINER_CLASS_BIKER]               = _("WILD RIDER"),
    [TRAINER_CLASS_BURGLAR]             = _("BURGLAR"),
    [TRAINER_CLASS_ENGINEER]            = _("ELECTRICIAN"),
